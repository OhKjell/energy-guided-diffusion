...
class EGG(nn.Module):
    def __init__(
            self,
            diffusion_artefact="/srv/pcpool/home/epool10/project/energy-guided"
                               "-diffusion/models/256x256_diffusion_uncond.pt",
            config=None,
            num_steps=50,
    ):
        super().__init__()
    ...
    def sample_video(
        ...
        return self.diffusion.p_sample_loop_progressive_dynamic(
            ...
            energy_fn=energy_fn,
            energy_fn2=energy_fn2,
            energy_fn3=energy_fn3,
            energy_scale=energy_scale,
            energy_scale2=energy_scale2,
            energy_scale3=energy_scale3,
            use_alpha_bar=use_alpha_bar,
            normalize_grad=normalize_grad,
            iterative=iterative,
